...
Relational databases are where the information and data is stored with SQL allows users to view the database.
2. Why do tables need a Primary Key?
Each table needs a primary key to reference the data being called or used. 
3. What is the name given to a table column that references the Primary Key on another table?
Foreign Key
4. What do we need in order to have a _many to many_ relationship between two tables?
We'd need to create another table that has foreign keys of the tables being referenced.
